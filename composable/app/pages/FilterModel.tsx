                        ...
                        return (
                            <TextButton
                                ...
                                buttonContainerStyle={{
                                    ...
                                    backgroundColor: item.key == timeValue? COLORS.primary : COLORS.lightGray2
                                }}
                        ...
                        return (
                            <TextIconButton
                                ...
                                containerStyle={{
                                    ...
                                    alignItems: "center",
                                    borderRadius: SIZES.base,
                                    backgroundColor: item.id == ratingsValue? COLORS.primary : COLORS.lightGray2
                                }}
                                label={item.label}
                                labelStyle={{
                                ...
                                iconStyle={{
                                    tintColor: item.id == ratingsValue ? COLORS.white: COLORS.gray
                                }}
